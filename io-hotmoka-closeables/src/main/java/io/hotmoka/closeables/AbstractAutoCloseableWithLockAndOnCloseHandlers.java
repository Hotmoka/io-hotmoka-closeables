...
import io.hotmoka.closeables.internal.AutoCloseableWithLockAndOnCloseHandlersImpl;
 ...
 * Moreover, it has support for close handlers, that must be called when the object gets closed.
 * 
 * @param <E> the type of exception thrown if {@link #mkScope()} is called after {@link #stopNewCalls()}
 */
@ThreadSafe
public abstract class AbstractAutoCloseableWithLockAndOnCloseHandlers<E extends Exception> extends AutoCloseableWithLockAndOnCloseHandlersImpl<E> {
	 ...
	 */
	protected AbstractAutoCloseableWithLockAndOnCloseHandlers(Supplier<E> exceptionSupplier) {
